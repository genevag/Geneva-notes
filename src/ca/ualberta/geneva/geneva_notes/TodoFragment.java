/* This class TODOFRAGMENT deals with displaying the todo list when the todo tab is selected.
...
public class TodoFragment extends ListFragment {
	...
	// adapter - for use in all methods below
	private static MyArrayAdapter adapter;
	
	// arraylist of integers to keep track of selected items to disard/archive/email
	private static ArrayList<Integer> helperPositionArray;
	
	// to store tabs while they are removing when in CAB mode
	private static ActionBar.Tab temptab1;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		adapter = new MyArrayAdapter(getActivity(), R.layout.list_item, MainController.getTodoList());
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		getListView().setMultiChoiceModeListener(new MultiChoiceModeListener() {
		    ...
		    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
				...
				switch (item.getItemId()) {
					case R.id.action_archive:
						controller.archiveItems(helperPositionArray);
						adapter.notifyDataSetChanged();
						
						Toast.makeText(getActivity(), R.string.items_archived, Toast.LENGTH_SHORT).show();
					...
					case R.id.action_discard:
						controller.removeTodoItems(helperPositionArray);			
						adapter.notifyDataSetChanged();
		    ...
		    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
		        ...
		        temptab1 = getActivity().getActionBar().getTabAt(1);
		        temptab2 = getActivity().getActionBar().getTabAt(2);
		        getActivity().getActionBar().removeTabAt(1);
		        getActivity().getActionBar().removeTabAt(1);
		        
		        // this line was taken from http://developer.android.com/guide/topics/ui/menus.html#CAB
		        inflater.inflate(R.menu.edit_screen, menu);
		        return true;
		    }
		    ...
		    public void onDestroyActionMode(ActionMode mode) {
		    	...
		    	getActivity().getActionBar().addTab(temptab1, 1);
